...
REM 	To use the script properly you need to pass in arguments the tests you want to run : 
REM			- "ATT&CK" to test Mitre ATT&CK PAYLOADS
REM			- "LOLBAS" to test LOLBAS PAYLOADS
...
:DEFAULT_CASE
  ECHO Unknown test framework"%test_type%"
  GOTO :EOF
...
:CASE_DOSfuscation
	...
	echo **********************************************
	echo *    Testing Invoke-DOSfuscation PAYLOADS    *
	echo **********************************************
	...
	GOTO :END_CASE
	REM ---- EOF Invoke-DOSfuscation Payloads ----
